...
and (close-sma30)/sma30*100 between -0.2 and 0.5
and a.pe < 50 and close < 20 
order by close;
...
and close > sma250
and (max10-sma250)/sma250*100 between 5 and 25
and (close-sma20)/sma20*100 between -0.2 and 0.5
and a.pe < 50 and close < 20 
order by close;
...
and close > sma250
and (max10-sma250)/sma250*100 between 5 and 25
and (close-sma10)/sma10*100 between -0.2 and 0.5
and a.pe < 50 and close < 20 
order by close;
